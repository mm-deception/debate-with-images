...
from utils import prompt_to_claude_conversation
...
def bean_gpt_api(
    ...
    messages = prompt_to_claude_conversation(user_prompt=user_content, system_prompt=None, images=images)

    

    openai_api = 'https://api.anthropic.com'
