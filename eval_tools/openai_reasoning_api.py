...
from utils import prompt_to_reason_conversation
...
def bean_gpt_api(
    ...
    messages = prompt_to_reason_conversation(user_content, system_content, images)
    ...
    while max_try > 0:
        try:
            ...
            if response.status == 200:
                # TODO
                response = json.loads(response.data.decode('utf-8'))['output']
